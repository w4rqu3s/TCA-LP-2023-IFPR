// VERSÃO LINUX - AINDA NÃO FOI COMPLETAMENTE TESTADA
...
int main(void)
{
    ...
    // avisos
    printf("ATENCAO - A VERSAO LINUX AINDA NAO FOI COMPLETAMENTE TESTADA\n");
    printf("EM CASO DE MAL FUNCIONAMENTO REPORTE NO GITHUB\n");
    system("PAUSE");
    system("cls");
